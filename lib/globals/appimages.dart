...
class Appimage {
  ...
  static Image sunnyicon =
      const Image(height: 80, image: AssetImage('assets/sunny.jpg'));
  static Image windicon =
      const Image(height: 50, image: AssetImage('assets/wind.jpg'));
